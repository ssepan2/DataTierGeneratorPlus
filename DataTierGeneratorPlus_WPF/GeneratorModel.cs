...
namespace DataTierGeneratorPlus 
{
    public class GeneratorModel : 
        EventObservable//Observable  //this is the Model 
    {

        #region declarations
        public static GeneratorModel model;
        ...
        public Boolean IsFileAssociation(String executablePath, String fileExtension, Boolean allowRegisterFileAssociation)
        {
            ...
            try
            {
                ...
                RegistryKey rkFileType = rkRoot.OpenSubKey("." + fileExtension);

                // Was the file type found?
                returnValue = (rkFileType != null);
                if (!returnValue)
                {
                    ...
                    if (allowRegisterFileAssociation)
                    {
                        ...
                        rkNew.SetValue("", fileExtension + ".settings");

                        // Create the file type information key
                        RegistryKey rkInfo = rkRoot.CreateSubKey(fileExtension + ".settings");

                        // Set the default value to the file type description
                        rkInfo.SetValue("", fileExtension + " File");
