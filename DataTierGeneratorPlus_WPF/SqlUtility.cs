...
//		}
        ...
        ) 
		{
            ...
            try
            {
                returnValue = Utility.GetResource("DataTierGeneratorPlus.Templates." + DBUTIL_FILE_DB_PRE + "TableMetadata." + CODE_EXTENSION, "#DatabaseName#", databaseName);
            }
            catch (Exception ex)
            {
                Log.Write(
        ...
        ) 
		{
            ...
            try
            {
                returnValue = Utility.GetResource("DataTierGeneratorPlus.Templates." + DBUTIL_FILE_DB_PRE + "ColumnMetadata." + CODE_EXTENSION, "#TableName#", table.Name);
        ...
        ) 
        {
            ...
            try
            {
                returnValue = Utility.GetResource("DataTierGeneratorPlus.Templates." + DBUTIL_FILE_DB_PRE + "UserCreate." + CODE_EXTENSION);
		...
		/// <summary>
		/// Retrieves a connection String corresponding to the configured DBMS and Authentication settings.
		/// </summary>
        ...
        )
		{
            ...
            try
            {
                if (settings.SQLAuthentication)
                {
                    returnValue = "Provider=sqloledb;Data Source=" + settings.Server + ";Initial Catalog=" + settings.Database + ";User Id=" + settings.SQLLogin + ";Password=" + settings.Password + ";";
                }
                else
                {
                    returnValue = "Provider=sqloledb;Data Source=" + settings.Server + ";Initial Catalog=" + settings.Database + ";Integrated Security=SSPI;";
                }
        ...
        ) 
		{
            ...
            try
            {
                ...
                using (OleDbCommand command = new OleDbCommand("sp_fkeys", connection))
                {
                    ...
                    parameter = new OleDbParameter(GeneratorModel.dbUtility.FormatStoredProcedureParameterName("pktable_name"), OleDbType.VarWChar, 128, ParameterDirection.Input, true, 0, 0, "pktable_name", DataRowVersion.Current, DBNull.Value);
                    command.Parameters.Add(parameter);
                    parameter = new OleDbParameter(GeneratorModel.dbUtility.FormatStoredProcedureParameterName("pktable_owner"), OleDbType.VarWChar, 128, ParameterDirection.Input, true, 0, 0, "pktable_owner", DataRowVersion.Current, DBNull.Value);
                    command.Parameters.Add(parameter);
                    parameter = new OleDbParameter(GeneratorModel.dbUtility.FormatStoredProcedureParameterName("pktable_qualifier"), OleDbType.VarWChar, 128, ParameterDirection.Input, true, 0, 0, "pktable_qualifier", DataRowVersion.Current, DBNull.Value);
                    command.Parameters.Add(parameter);
                    parameter = new OleDbParameter(GeneratorModel.dbUtility.FormatStoredProcedureParameterName("fktable_name"), OleDbType.VarWChar, 128, ParameterDirection.Input, true, 0, 0, "fktable_name", DataRowVersion.Current, table.Name);
                    command.Parameters.Add(parameter);
                    parameter = new OleDbParameter(GeneratorModel.dbUtility.FormatStoredProcedureParameterName("fktable_owner"), OleDbType.VarWChar, 128, ParameterDirection.Input, true, 0, 0, "fktable_owner", DataRowVersion.Current, DBNull.Value);
                    command.Parameters.Add(parameter);
                    parameter = new OleDbParameter(GeneratorModel.dbUtility.FormatStoredProcedureParameterName("fktable_qualifier"), OleDbType.VarWChar, 128, ParameterDirection.Input, true, 0, 0, "fktable_qualifier", DataRowVersion.Current, DBNull.Value);
                    command.Parameters.Add(parameter);
        ...
        ) 
		{
            ...
            try
            {
                ...
                using (OleDbCommand command = new OleDbCommand("sp_pkeys", connection))
                {
                    ...
                    parameter = new OleDbParameter(GeneratorModel.dbUtility.FormatStoredProcedureParameterName("table_name"), OleDbType.VarWChar, 128, ParameterDirection.Input, false, 0, 0, "table_name", DataRowVersion.Current, table.Name);
                    command.Parameters.Add(parameter);
                    parameter = new OleDbParameter(GeneratorModel.dbUtility.FormatStoredProcedureParameterName("table_owner"), OleDbType.VarWChar, 128, ParameterDirection.Input, true, 0, 0, "table_owner", DataRowVersion.Current, table.Schema);
                    command.Parameters.Add(parameter);
                    parameter = new OleDbParameter(GeneratorModel.dbUtility.FormatStoredProcedureParameterName("table_qualifier"), OleDbType.VarWChar, 128, ParameterDirection.Input, true, 0, 0, "table_qualifier", DataRowVersion.Current, DBNull.Value/*table.Catalog*/);
                    command.Parameters.Add(parameter);
        ...
        ) 
        {
            ...
            try
            {
                ...
                {
                    case "binary":
                        returnValue = "" + GeneratorModel.dbUtility.FormatStoredProcedureParameterName(columnName) + " " + column.Type + "(" + column.Length + ")";
                        break;
                    case "bigint":
                        returnValue = "" + GeneratorModel.dbUtility.FormatStoredProcedureParameterName(columnName) + " " + column.Type;
                        break;
                    case "bit":
                        returnValue = "" + GeneratorModel.dbUtility.FormatStoredProcedureParameterName(columnName) + " " + column.Type;
                        break;
                    ...
                    case "decimal":
                        if (column.Scale.Length == 0)
                            returnValue = "" + GeneratorModel.dbUtility.FormatStoredProcedureParameterName(columnName) + " " + column.Type + "(" + column.Precision + ")";
                        else
                            returnValue = "" + GeneratorModel.dbUtility.FormatStoredProcedureParameterName(columnName) + " " + column.Type + "(" + column.Precision + ", " + column.Scale + ")";
                        break;
                    case "float":
                        returnValue = "" + GeneratorModel.dbUtility.FormatStoredProcedureParameterName(columnName) + " " + column.Type + "(" + column.Precision + ")";
                        break;
            ...
            )
		{
            ...
            try
            {
                ...
                Type dotNetType = Type.GetType("System." + returnValue);
