	...
	class VbGeneratorBuiltIn : VsGenerator
	{
        ...
        ) 
		{
            ...
            try
            {
                ...
                {
                    streamWriter.Write(GetDatabaseUtilityClass(model));
                }
                returnValue = true;
            }
            catch (Exception ex)
        ...
        )
        {
            ...
            try
            {
                ...
                returnValue = Utility.GetResource("DataTierGeneratorPlusLibrary.Templates." + TEMPLATE_FILE_VS_PRE + "DatabaseUtility.txt");

                if (IsNameSpace)
                {
                    returnValue = returnValue.Replace("#BeginNamespace#", "NameSpace " + model.Namespace + "");
                    returnValue = returnValue.Replace("#EndNamespace#", "End NameSpace");
                    returnValue = returnValue.Replace("#Namespace#", model.Namespace + ".");
                }
                else
                {
                ...
                returnValue = returnValue.Replace("#Client#", GeneratorModel.DatabaseUtility.DotNetFrameworkClientLib());
                returnValue = returnValue.Replace("#SqlConnection#", GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibConnection());
                returnValue = returnValue.Replace("#Command#", GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibCommand());
                returnValue = returnValue.Replace("#DataAdapter#", GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataAdapter());
                returnValue = returnValue.Replace("#DataReader#", GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader());
                returnValue = returnValue.Replace("#Connection#", GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibConnection());
                returnValue = returnValue.Replace("#Transaction#", GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibTransaction());
                returnValue = returnValue.Replace("#Parameter#", GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibParameter());
            }
            catch (Exception ex)
            {
                Log.Write(ex, MethodBase.GetCurrentMethod(), EventLogEntryType.Error);
        ...
        )
        {
            ...
            try
            {
                ...
                {
                    streamWriter.Write(GetNullHandlerClass(model));
                }
                returnValue = true;
            }
            catch (Exception ex)
        ...
        )
        {
            ...
            try
            {
                Boolean IsNameSpace = (model.Namespace.Trim() != "");

                returnValue = Utility.GetResource("DataTierGeneratorPlusLibrary.Templates." + TEMPLATE_FILE_VS_PRE + "NullHandler.txt");
        ...
        )
        {
            ...
            try
            {
                ...
                {
                    streamWriter.Write(GetSortComparerClass(model));
                }
                returnValue = true;
            }
            catch (Exception ex)
        ...
        )
        {
            ...
            try
            {
                ...
                returnValue = Utility.GetResource("DataTierGeneratorPlusLibrary.Templates." + TEMPLATE_FILE_VS_PRE + "SortComparer.txt");
        ...
        )
        {
            ...
            try
            {
                ...
                {
                    streamWriter.Write(GetBindingListViewClass(model));
                }
                returnValue = true;
            }
            catch (Exception ex)
        ...
        )
        {
            ...
            try
            {
                ...
                returnValue = Utility.GetResource("DataTierGeneratorPlusLibrary.Templates." + TEMPLATE_FILE_VS_PRE + "BindingListView.txt");
        ...
        )
        {
            ...
            try
            {
                ...
                if (IsNameSpace)
                {
                    ...
                    streamWriter.WriteLine("'Namespace " + model.Namespace + " ");
                }
                ...
                for (int i = 0; i < table.Columns.Count; i++)
                {
                    ...
                    streamWriter.WriteLine("\t\tPrivate " + " _" + column.ProgrammaticAlias + " As " + GeneratorModel.DatabaseUtility.GetDotNetTypeNameFromDbTypeName(column, false) + "");
                }
                ...
                for (int i = 0; i < table.Columns.Count; i++)
                {
                    ...
                    streamWriter.WriteLine("\t\tPublic Property " + column.ProgrammaticAlias + " As " + GeneratorModel.DatabaseUtility.GetDotNetTypeNameFromDbTypeName(column, false) + "");
                    streamWriter.WriteLine("\t\t\tGet ");
                    streamWriter.WriteLine("\t\t\t\tReturn _" + column.ProgrammaticAlias + " ");
                    streamWriter.WriteLine("\t\t\tEnd Get");
                    streamWriter.WriteLine("\t\t\tSet(ByVal Value As " + GeneratorModel.DatabaseUtility.GetDotNetTypeNameFromDbTypeName(column, false) + ") ");
		...
		) 
		{
            ...
            try
            {
                ...
                String className = Utility.CleanWhitespace(Utility.FormatPascal(table.ProgrammaticAlias + "Controller" + model.ClassSuffix));
                className = Utility.FilterPathCharacters(className);
                ...
                streamWriter.WriteLine("Imports System.Data." + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLib() + "");
                streamWriter.WriteLine("Imports System.ComponentModel");
		...
		) 
		{
            ...
            try
            {
                ...
                foreach (List<Column> compositeKeyList in table.ForeignKeys.Values)
                {
                    ...
                    stringBuilder.Append("[" + table.Schema + "].[" + /*model.SPPrefix +*/ table.Name + "DeleteBy");
		...
		) 
		{
            ...
            try
            {
                if (table.PrimaryKeys.Count > 0 && table.Columns.Count != table.ForeignKeys.Count)
                {
                    ...
                    // Close parameter list
                    streamWriter.WriteLine(") As " + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader() + " ");
        ...
        )
        {
            ...
            try
            {
                ...
                if (table.PrimaryKeys.Count > 0 && table.Columns.Count != table.ForeignKeys.Count)
                {
                    ...
                    streamWriter.Write("\t\t\tUsing dr As " + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader() + " = SelectDR (");
		...
		) 
		{
            ...
            try
            {
                if (table.Columns.Count != table.PrimaryKeys.Count && table.Columns.Count != table.ForeignKeys.Count)
                {
                    ...
                    streamWriter.WriteLine("\t\t''' </summary>");
                    streamWriter.WriteLine("\t\t<DataObjectMethodAttribute(DataObjectMethodType.Select, False)> _");
                    streamWriter.WriteLine("\t\tPublic Shared Function SelectDRAll() As " + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader() + "  ");
        ...
        )
        {
            ...
            try
            {
                ...
                if (table.Columns.Count != table.PrimaryKeys.Count && table.Columns.Count != table.ForeignKeys.Count)
                {
                    ...
                    // Append the using header and stored procedure execution
                    streamWriter.Write("\t\t\tUsing dr As " + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader() + " = SelectDRAll(");
		...
		) 
		{
            ...
            try
            {
                ...
                foreach (List<Column> compositeKeyList in table.ForeignKeys.Values)
                {
                    // Create the stored procedure name
                    StringBuilder stringBuilder = new StringBuilder(255);
                    stringBuilder.Append("[" + table.Schema + "].[" + /*model.SPPrefix +*/ table.Name + "SelectBy");
                    for (int i = 0; i < compositeKeyList.Count; i++)
                    {
                        Column column = (Column)compositeKeyList[i];
        ...
        )
        {
            ...
            try
            {
                ...
                foreach (List<Column> compositeKeyList in table.ForeignKeys.Values)
                {
                    ...
                    // Append the using header and stored procedure execution
                    streamWriter.Write("\t\t\tUsing dr As " + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader() + " = " + methodName2 + "(");
         ...
         )
         {
             ...
             try
             {
                 ...
                 if (table.Columns.Count != table.PrimaryKeys.Count && table.Columns.Count != table.ForeignKeys.Count)
                 {
                     ...
                     streamWriter.WriteLine("\t\t''' </summary>");
                     streamWriter.WriteLine("\t\tProtected Shared Function LoadListDR(ByVal dr As " + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader() + ") As BindingListView(Of " + className + ")  ");
        ...
        )
        {
            ...
            try
            {
                ...
                {
                    streamWriter.Write(GetDataAccessCustomClass(table, model));
                }
                returnValue = true;
            }
            catch (Exception ex)
        ...
        )
        {
            ...
            try
            {
                ...
                returnValue = Utility.GetResource("DataTierGeneratorPlusLibrary.Templates." + TEMPLATE_FILE_VS_PRE + "DataControllerCustom.txt");
        ...
        )
        {
            ...
            try
            {
                ...
                returnValue = Utility.GetResource("DataTierGeneratorPlusLibrary.Templates.WcfServiceSVC.txt");
       ...
       (
        ...
        )
        {
            ...
            try
            {
                ...
                using (StreamWriter streamWriter = new StreamWriter(Path.Combine(path, className + ".Custom." + CODE_FILE_EXT)))
                {
                    streamWriter.Write(GetWcfServiceCustomClass(table, model));
                }
                returnValue = true;
            }
            catch (Exception ex)
        ...
        )
        {
            ...
            try
            {
                ...
                returnValue = Utility.GetResource("DataTierGeneratorPlusLibrary.Templates." + TEMPLATE_FILE_VS_PRE + "WcfServiceCustom.txt");
        ...
        )
        {
            ...
            try
            {
                ...
                String className = Utility.CleanWhitespace(Utility.FormatPascal(table.ProgrammaticAlias + "" + model.ClassSuffix));
                className = Utility.FilterPathCharacters(className);
                ...
                // Append the access methods
                if (!CreateToListOfContractServiceExtension(table, streamWriter, model))
                {
                    throw new ApplicationException("Unable to Create ToListOfContract Service Extension.");
                }
                if (!CreateToContractServiceExtension(table, streamWriter, model))
                {
                    throw new ApplicationException("Unable to Create ToContract Service Extension.");
                }
                if (!CreateToInfoServiceExtension(table, streamWriter, model))
                {
        ...
        )
        {
            ...
            try
            {
                ...
                streamWriter.WriteLine("Imports System.Runtime.CompilerServices");
                streamWriter.WriteLine("Imports System.Collections.Generic");
                streamWriter.WriteLine("Imports " + model.Namespace + "." + className + "Service");
                ...
                // Append the access methods
                if (!CreateToListOfContractServiceClientExtension(table, streamWriter, model))
                {
        ...
        )
        {
            ...
            try
            {
                ...
                {
                    streamWriter.Write(GetWcfServiceClientAppCodeClass(table, model));
                }
                returnValue = true;
            }
            catch (Exception ex)
        ...
        )
        {
            ...
            try
            {
                ...
                String classVariableName = Utility.CleanWhitespace(Utility.FormatCamel(table.ProgrammaticAlias + "" + model.ClassSuffix));
                classVariableName = Utility.FilterPathCharacters(classVariableName);

                returnValue = Utility.GetResource("DataTierGeneratorPlusLibrary.Templates." + TEMPLATE_FILE_VS_PRE + "WcfServiceClientApplication.txt");
        ...
        )
        {
            ...
            try
            {
                dotNetTypeName = GeneratorModel.DatabaseUtility.GetDotNetTypeNameFromDbTypeName(column, false);
            ...
            catch (Exception ex)
            {
                Log.Write(ex, MethodBase.GetCurrentMethod(), EventLogEntryType.Error);
                Log.Write(
                    Log.FormatEntry(String.Format("Column: {0}", column.ProgrammaticAlias), MethodBase.GetCurrentMethod().DeclaringType.FullName, MethodBase.GetCurrentMethod().Name),
        ...
        )
        {
            ...
            try
            {
                returnValue = String.Format("New {0}(\"{1}\", NullHandler.HandleAppNull({2}{3}, DBNull.Value))", GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibParameter(), GeneratorModel.DatabaseUtility.FormatStoredProcedureParameterName(column.ProgrammaticAlias), columnPrefix, column.ProgrammaticAlias);
            }
            catch (Exception ex)
            {
                Log.Write(ex, MethodBase.GetCurrentMethod(), EventLogEntryType.Error);
                Log.Write(
                    Log.FormatEntry(String.Format("Column: {0}\r\nPrefix: {1}", column.ProgrammaticAlias, columnPrefix), MethodBase.GetCurrentMethod().DeclaringType.FullName, MethodBase.GetCurrentMethod().Name),
                    EventLogEntryType.Error);
                throw;
            }
            return returnValue;
