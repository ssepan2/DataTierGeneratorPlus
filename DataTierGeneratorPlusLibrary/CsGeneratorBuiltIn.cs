    ...
    class CsGeneratorBuiltIn : VsGenerator
	{
        ...
        )
        {
            ...
            try
            {
                ...
                for (int i = 0; i < table.Columns.Count; i++)
                {
                    ...
                    streamWriter.WriteLine("\t\tprivate " + GeneratorModel.DatabaseUtility.GetDotNetTypeNameFromDbTypeName(column, false) + " _" + column.ProgrammaticAlias + ";");
                }
                ...
                for (int i = 0; i < table.Columns.Count; i++)
                {
                    ...
                    streamWriter.WriteLine("\t\tpublic " + GeneratorModel.DatabaseUtility.GetDotNetTypeNameFromDbTypeName(column, false) + " " + column.ProgrammaticAlias + "{");
		...
		) 
		{
            ...
            try
            {
                ...
                streamWriter.WriteLine("using System.Data." + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLib() + ";");
                streamWriter.WriteLine("using System.ComponentModel;");
		...
		) 
		{
            ...
            try
            {
                if (table.PrimaryKeys.Count > 0 && table.Columns.Count != table.ForeignKeys.Count)
                {
                    ...
                    streamWriter.Write("\t\tpublic static " + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader() + " SelectDR(");
                    StringBuilder builder = new StringBuilder();
                    foreach (Column column in table.PrimaryKeys)
                    {
                        builder.Append(CreateMethodFormalParameter(column) + ", ");
        ...
        )
        {
            ...
            try
            {
                ...
                if (table.PrimaryKeys.Count > 0 && table.Columns.Count != table.ForeignKeys.Count)
                {
                    ...
                    streamWriter.Write("\t\t\tusing (" + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader() + " dr = SelectDR(");
		...
		) 
		{
            ...
            try
            {
                if (table.Columns.Count != table.PrimaryKeys.Count && table.Columns.Count != table.ForeignKeys.Count)
                {
                    ...
                    streamWriter.WriteLine("\t\tpublic static " + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader() + " SelectDRAll() \r\n\t\t{");
        ...
        )
        {
            ...
            try
            {
                ...
                if (table.Columns.Count != table.PrimaryKeys.Count && table.Columns.Count != table.ForeignKeys.Count)
                {
                    ...
                    // Append the using header and stored procedure execution
                    streamWriter.Write("\t\t\tusing (" + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader() + " dr = SelectDRAll(");
		...
		/// <param name="table">The Table instance that this method will be created for.</param>
		/// <param name="streamWriter">The StreamWriter instance that will be used to create the method.</param>
		/// <param name="model">User model.</param>C:\Documents and Settings\ssepan\My Documents\Visual Studio 2008\Projects\DataTierGeneratorPlusLibrary6x\frmAbout.cs
		...
		) 
		{
            ...
            try
            {
                ...
                foreach (List<Column> compositeKeyList in table.ForeignKeys.Values)
                {
                    ...
                    streamWriter.Write("\t\tpublic static " + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader() + " " + methodName + "(");
                    StringBuilder builder = new StringBuilder();
                    for (int i = 0; i < compositeKeyList.Count; i++)
                    {
                        Column column = (Column)compositeKeyList[i];
        ...
        )
        {
            ...
            try
            {
                ...
                foreach (List<Column> compositeKeyList in table.ForeignKeys.Values)
                {
                    ...
                    // Append the using header and stored procedure execution
                    streamWriter.Write("\t\t\tusing (" + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader() + " dr = " + procedureName + "(");
        ...
        )
        {
            ...
            try
            {
                ...
                if (table.Columns.Count != table.PrimaryKeys.Count && table.Columns.Count != table.ForeignKeys.Count)
                {
                    ...
                    streamWriter.WriteLine("\t\t/// </summary>");
                    streamWriter.WriteLine("\t\tprotected static BindingListView<" + className + "> LoadListDR(" + GeneratorModel.DatabaseUtility.DotNetFrameworkClientLibDataReader() + " dr) \r\n\t\t{ ");
                    ...
                    foreach (Column column in table.Columns)
                    {
                        if (column.IsIdentity == false && column.IsRowGuidCol == false)
                        {
                            builder.Append("\t\t\t\t\t\t(" + GeneratorModel.DatabaseUtility.GetDotNetTypeNameFromDbTypeName(column, false) + ")NullHandler.HandleDbNull(dr[\"" + Utility.FormatCamel(column.ProgrammaticAlias) + "\"]),\r\n");
                        }
                    }
       ...
       (
        ...
        )
        {
            ...
            try
            {
                ...
                streamWriter.WriteLine("using System.Collections.Generic;");
                streamWriter.WriteLine("using " + model.Namespace + "." + className + "Service;");
