...
{
	abstract  class DbUtility : IDbUtility
	{
//		public abstract String DbUtilFileDbPrefix();

		public abstract String DotNetFrameworkClientLib();
		public abstract String DotNetFrameworkClientLibConnection();
		public abstract String DotNetFrameworkClientLibTransaction();
		public abstract String DotNetFrameworkClientLibCommand();
		public abstract String DotNetFrameworkClientLibParameter();
		public abstract String DotNetFrameworkClientLibDataReader();
		public abstract String DotNetFrameworkClientLibDataAdapter();
		...
		public abstract String GetTableQuery(String databaseName) ;
		...
		public abstract String GetColumnQuery(Table table) ;
		...
		public abstract String GetUserQueries(String databaseName, String grantLoginName) ;
		...
		public abstract String GetConnectionString(Settings settings);
		...
		public abstract DataTable GetForeignKeyList(OleDbConnection connection, Table table) ;
		...
		public abstract DataTable GetPrimaryKeyList(OleDbConnection connection, Table table) ;
		...
		public abstract String CreateStoredProcedureFormalParameterString(Column column);
        ...
        public abstract String GetDotNetTypeNameFromDbTypeName(Column column, Boolean nonNullable);
        ...
        ///// <param name="column">Object that stores the information for the column the parameter represents.</param>
        ///// <returns>String containing System.Data.DbType.</returns>
        //public abstract String GetDotNetTypeNameFromDbTypeName(Column column);
		...
		public abstract String FormatStoredProcedureParameterName(String parameterName);
