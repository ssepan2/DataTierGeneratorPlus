...
namespace DataTierGeneratorPlus
{
    ...
    public class Settings :
        Ssepan.Application.SettingsBase
    {
        #region declarations
        //public const String FILE_NEW = "(new)";
        public new const String FILE_TYPE_EXTENSION = "dtgp"; //"xml";
        public new const String FILE_TYPE_NAME = "datatiergeneratorplusfile";
        public new const String FILE_TYPE_DESCRIPTION = "DataTierGeneratorPlus Settings File";
        ...
        //inherited; override ifadditional cleanup needed
        ...
        public override Boolean Equals(ISettings other)
        {
            ...
            try
            {
                ...
                {
                    if (this.AutoSelectOnLoad != otherSettings.AutoSelectOnLoad)
                    {
                        returnValue = false;
                    }
                    ...
                    else if (this.GenerateDataLayerClassesCheckBox != otherSettings.GenerateDataLayerClassesCheckBox)
                    {
                        returnValue = false;
                    }
                    ...
                    else if (this.Size != otherSettings.Size)
                    {
                        returnValue = false;
                    }
                    else if (this.Location != otherSettings.Location)
                    {
                        returnValue = false;
                    }
                    else
        ...
        #region Properties
        public new static Settings AsStatic
        {
            get { return Ssepan.Application.SettingsBase.AsStatic as Settings; }
            set
            {
                Ssepan.Application.SettingsBase.AsStatic = value;
            }
        }
        ...
        /// <summary>
        /// Saves the current object's data to the specified file.
        /// </summary>
        /// <param name="filePath"></param>
