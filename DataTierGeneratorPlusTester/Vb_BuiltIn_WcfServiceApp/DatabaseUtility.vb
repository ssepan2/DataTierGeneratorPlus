        ...
        Public Shared Function GetConnectionString(ByVal connectionStringKeyName As String) As String
            ...
            Else
                ...
                Else
                    ...
                    'If Not (Vb_BuiltIn_WcfServiceApp.Properties.Settings.Default[connectionStringKeyName] Is Nothing) Then '<--WinForms only
                    '    Return Vb_BuiltIn_WcfServiceApp.Properties.Settings.Default[connectionStringKeyName].ToString()
                    'Else
                        Return String.Empty
                    'End If
