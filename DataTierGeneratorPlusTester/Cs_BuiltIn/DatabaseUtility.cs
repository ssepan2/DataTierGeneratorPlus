	...
	public sealed class DatabaseUtility {
		...
		public static String GetConnectionString(String connectionStringKeyName) 
		{
            ...
            else
            {
                ...
                {
                    //if (Cs_BuiltIn.Properties.Settings.Default[connectionStringKeyName] != null) //<--WinForms only
                    //{
                    //    return Cs_BuiltIn.Properties.Settings.Default[connectionStringKeyName].ToString();
                    //}
                    //else
                    //{
                        return String.Empty;
